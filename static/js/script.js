function fileValidation() {
	var jeepney = document.getElementById('jeepney').checked;
    var bus = document.getElementById('bus').checked;
    var uv = document.getElementById('uv').checked;

    if (!jeepney && !bus && !uv) {
        alert("Please select a PUV type before uploading.");
	...
	var requiredHeaders = ['date', 'PULocationID', 'day_of_week', 'passenger_count', 'trip_distance', 'trip_duration', 'PUBorough', 'DOBorough'];
